...
## Devising of a pedestrian typology from a household travel survey and mapping of the resulting profiles based on Factorial Analysis of Mixed Data and Hierarchical  Agglomerative Clustering
...
## Construction d'une typologie piétonne à partir d'une enquête ménages déplacements et cartographie des profils résultants à l'aide d'une analyse factorielle de données mixtes et d'une classification ascendante hiérarchique
